export default function StatCard({ icon, label, value, change, up, iconBg }) {
  return (
    <div className="bg-white rounded-2xl border border-green-100 p-5 flex items-start gap-4 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-default">
      <div
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-2xl font-bold text-gray-900 font-mono my-1 tracking-tight">
          {value}
        </p>
        <p
